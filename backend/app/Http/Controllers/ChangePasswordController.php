...
class ChangePasswordController extends Controller
{
    ...
    private function getPasswordResetTableRow($request){
        return DB::table('password_resets')->where(['email' => $request->email,'token' =>$request->reserToken]);
    }
    ...
    private function changePassword($request)
    {
        ...
        return response()->json(['data'=>'Successfully Changed'],Response::HTTP_CREATED)
    }
}
